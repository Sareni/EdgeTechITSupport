            ...
            default:
                return [
                    ...
                    <ul id="dropdown1" className="dropdown-content">
                        <li><a href='#!' className='blue-grey-text'><i className="material-icons left" style={{marginRight: '19px', marginLeft: '0px'}}>info</i>Account</a></li>
        ...
        return (
            <nav className='blue-grey'>
                <div className='nav-wrapper container'>
                    ...
                    >
                        <i className="material-icons left">desktop_mac</i>
                        Edge TECH - IT Support
                    </Link>
                    <ul className='right'>
                        { this.renderContent() }
                    </ul>
